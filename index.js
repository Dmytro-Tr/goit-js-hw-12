        ...
        <li class="gallery-item">
          ...
          <ul class="gallery-description-list">
            ...
            <li class="gallery-description-item">
              ...
              <p class="gallery-description-quantity">${p}</p>
            </li>
          </ul>
        </li>
        `).join("")}const n=new d(".gallery-link",{captionsData:"alt",captionDelay:250}),u=document.querySelector(".js-search-form"),a=document.querySelector(".js-gallery"),c=document.querySelector(".loader");u.addEventListener("submit",L);function L(s){s.preventDefault();const i=s.target.elements.search.value.trim();i.trim()!==""&&(c.style.display="block",g(i).then(r=>{if(c.style.display="none",r.hits.length===0){S();return}a.innerHTML=h(r.hits),n&&n.refresh()}),u.reset(),a.innerHTML="")}function S(){f.show({message:"Sorry, there are no images matching your search query. Please try again!",titleSize:"16px",messageColor:"#fff",backgroundColor:"#ef4040",position:"topRight",timeout:"3000",closeOnClick:"true",progressBarColor:"#fff",transitionIn:"bounceInDown",transitionOut:"fadeOutLeft"})}
